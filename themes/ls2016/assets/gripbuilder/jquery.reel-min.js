...
NOTE:: THERE ARE CUSTOM MODIFICATIONS TO THIS FILE!!
The re.image regex test has been modified to include the query vars in the generated image.
This is done by adding another capturing group to the regex, and outputting that captured
group when rewriting the image file into the background image.
vanchuck@gmail.com / april 24 2013
...
jQuery.reel || (function($, window, document, undefined){
  ...
  var
    reel= $.reel= {
            ...
            var
              ...
              on= {
                ...
                setup: function(e){
                  ...
                  set(_image_, images.length ? __ : opt.image || src.replace(reel.re.image, '$1' + opt.suffix + '.$2$3'));
                  set(_cached_, []);
                ...
                instance: {
                  ...
                  */
                  ...
                  frameChange: function(e, set_frame, frame){
                    $(opt.area).attr('class',frame_klass + frame);
      ...
      // `String` (URL path), since 1.1
      //
      cdn: '/themes/common/assets/gripbuilder/',
