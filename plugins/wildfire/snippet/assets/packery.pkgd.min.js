...
$(document).ready( function(){
    $('.subcategories a').click(function(el){
        var linky = $(this);
        $('.subcategories a.selected').removeClass('selected');
        if (linky.attr('catslug')){
            $('.athlete').not('.category-' + linky.attr('catslug')).fadeOut(500, function(){$grid.packery('layout');});
            $('.athlete.category-' + linky.attr('catslug')+':hidden').fadeIn(500);
            linky.addClass('selected');
        }
        else {
            $('.athlete:hidden').fadeIn(500, function(){$grid.packery('layout');});
            linky.addClass('selected');
        }
        $grid.packery();
        return false;
