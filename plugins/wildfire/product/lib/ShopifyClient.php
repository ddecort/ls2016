<?php
namespace wildfire\Product\lib;
...
class ShopifyClient {
    ...
    public function __construct($shop_domain, $api_key, $password, $secret) {
        $this->name = "ShopifyClient";
        $this->shop_domain = $shop_domain;
        //removed from parameters $this->token = $token;
    ...
    public function call($method, $path, $params=array())
    {
        ...
        // add auth headers
        // DBA -- $request_headers[] = 'X-Shopify-Access-Token: ' . $this->token;
